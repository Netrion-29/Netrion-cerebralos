...
> - E05 CAUTI Tier-1 spec fidelity (CDC SUTI 1a): ✅ COMPLETE — 5 required gates (cauti_dx, cauti_catheter_gt2d, cauti_symptoms, cauti_culture, cauti_after_arrival) + 2 exclusions (POA, chronic catheter); 6 new mapper keys (52 patterns total); cauti_dx expanded with UTI standalone + negation noise filter; 52 precision tests + 3 fixtures (YES, nursing-YES, no-catheter-NO); 0 NTDS outcome deltas (rule-only, pre-rerun)
> - Open PRs: tier2/e05-cauti-spec-v1
> - **Backlog priority:** (1) E05 CAUTI cohort rerun + baseline update, (2) Tier 2 PROGRESS_NOTE scoping pass, (3) Delirium shift compliance audit script, (4) PMH-aware gate handling (engine-protected) — see Roadmap doc §3
>
