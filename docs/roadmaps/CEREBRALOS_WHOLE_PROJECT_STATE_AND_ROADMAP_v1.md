...
| 6 | Source alignment (PROGRESS_NOTE + NURSING_NOTE) | Docs/design: per-event allowed_sources vs raw DATA SOURCE hierarchy; PROGRESS_NOTE/NURSING_NOTE inclusion plan; ED/ANESTHESIA adds justified | High | Medium | No rule changes yet — produce alignment table and recommendations PR first |
