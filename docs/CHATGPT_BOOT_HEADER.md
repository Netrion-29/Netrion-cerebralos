...
| Repo-hardening findings (AUD-013–016) | 🔍 TRACKED, SEQUENCED — queued, not implemented. Order: (1) validator hardening — contract leak guard + provenance parity (AUD-013/014, one PR), (2) v3 output baseline (AUD-015), (3) determinism broadening (AUD-016). All `TIGHTEN NEXT`. See Roadmap §3 audit intake log. |
