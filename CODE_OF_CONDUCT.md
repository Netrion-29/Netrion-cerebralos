...
CerebralOS processes protected health information (PHI) locally.
Patient-identifying content — including names, medical record numbers,
and any data derived from patient records — must never be posted in
issues, pull requests, discussions, commit messages, or any other public
collaboration space. See [SECURITY.md](SECURITY.md) for full PHI and
...
repository, issue tracker, pull requests, and discussions. It also
